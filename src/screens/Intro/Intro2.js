    ...
    <View style={styles.viewBody}>
      <View style={styles.viewContent}>
        <Text style={styles.content}>
          ¿Has reflexionado alguna vez sobre cómo suceden los pensamientos en tu
          cabeza y cómo se articulan tus ideas?
        </Text>
        <Text style={styles.content}>
          ¿Cuáles son los pensamientos e ideas más recurrentes?!
        </Text>
      </View>
